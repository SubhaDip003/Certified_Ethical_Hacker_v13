...
### The resumption of a previous session or the replication of an existing session proceeds as follows: ▪ The client initiates the communication by sending a hello message with the session ID of the session that is to be resumed.
